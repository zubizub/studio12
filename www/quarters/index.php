...
<div class="wrapper quarter-page">
    <div class="inner">
                ...
                <div class="nav nav--light">
                    <div class="nav__inner">
                        ...
                        <div class="nav__item nav__item--queue">
                            <span class="nav__item-text">1-ая очередь: <a class="link nav__link" href="#">Январь/2017
                                г.</a></span>
                        </div>
                        <div class="nav__item nav__item--shoowroom">
                            <span class="nav__item-text">Shoowroom: <a class="link nav__link"
                                                                       href="#">Studio#8</a></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="head">
            <h1 class="heading"><span class="heading__line"><span
                    class="heading__word invisible">Лофт</span></span><span class="heading__line"><span
                    class="heading__word invisible">квартал</span>
                    ...
                    <div class="loft-types__slide">
                        <div class="loft-types__list">
                            <div class="loft-types__item">
                                <img src="/local/templates/studio12/dist/img//loft-type-1.jpg" class="loft-types__img"
                                     alt="#">
                            ...
                            <div class="loft-types__item">
                                <img src="/local/templates/studio12/dist/img//loft-type-2.jpg" class="loft-types__img"
                                     alt="#">
            ...
            <div class="reasons__content">
                ...
                <div class="reasons__row">
                    <div class="row">
                        ...
                        "PAGER_DESC_NUMBERING_CACHE_TIME" => "36000", // Время кеширования страниц для обратной
                        навигации
                        ...
                        "PARTIAL_PRODUCT_PROPERTIES" => "N", // Разрешить добавлять в корзину товары, у которых
                        заполнены не все характеристики
                        "PRICE_CODE" => "", // Тип цены
                        "PRICE_VAT_INCLUDE" => "Y", // Включать НДС в цену
                        "PRODUCT_ID_VARIABLE" => "id", // Название переменной, в которой передается код товара для
                        покупки
                        "PRODUCT_PROPERTIES" => "", // Характеристики товара
                        "PRODUCT_PROPS_VARIABLE" => "prop", // Название переменной, в которой передаются характеристики
                        товара
                        "PRODUCT_QUANTITY_VARIABLE" => "", // Название переменной, в которой передается количество
                        товара
...
<div class="metro-place">
    ...
    <div class="metro-place__item"><img class="metro-place__img" src="<?=SITE_TEMPLATE_PATH?>/dist/img//metro-loc.png"
                                        alt="#"></div>
</div>
        ...
        <div class="inner">
            <div class="about-lofts__row row">
                ...
                <div class="col-1-3">
                    ...
                    <div class="about-lofts__p">Москва, СВАО, <br><a class="link yellow" href="#">12-й пр. Марьиной Рощи
                        8 <br></a>
