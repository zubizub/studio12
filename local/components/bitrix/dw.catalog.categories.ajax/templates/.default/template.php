...
<g display="none">
			...
			"></polygon>
                                        <polygon display="inline" fill="#1E1F1F" points="113.542,226.549 142.227,197.664 142.227,185.393 113.542,214.084 	"></polygon>
...
<g display="none">
	...
	62.25,152.75 50.5,164.5 21.874,135.876 69.991,88.312 147.272,88.264 179.201,56.201 241.125,117.875 "></polygon>
<g display="none">
                                        <polygon display="inline" fill="#2D2E2E" points="150.089,177.459 139.792,156.792 129.495,158.292 129.495,169.334
		150.089,189.923 	"></polygon>
                                        <polygon display="inline" fill="#1E1F1F" points="150.089,189.923 200.014,139.801 200.014,127.529 150.089,177.459 	"></polygon>
...
if ($_GET['debug']) { 
            //print_r('<pre>');print_r($arFields);print_r('</pre>');
