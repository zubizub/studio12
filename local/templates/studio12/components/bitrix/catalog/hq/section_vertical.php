...
<?// $_GET['PAGEN_1']=2;?>
	...
	<input type='hidden' id="nElements" value="<?=$GLOBALS['nELEMENT_COUNT'];?>">
...
<?if ($isFilter || $isSidebar):?>
   <div class="sidebar">
	<?if ($isFilter):?>
		...
		<? $sectionParams = json_encode($arParams);?>
		<input name="arParams" type="hidden" value='<?=$sectionParams;?>' id="arParams">
		</div>
	</div>
	<?endif;?>
		<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"CACHE_TIME" => "36000",
		"CACHE_TYPE" => "A",
		"COMPONENT_TEMPLATE" => "section_promo",
