...
<? global $USER; ?>
							...
							<? if (!$key) { ?>
							<div class="loft-types__item" data-bg="<?=$arItem["PICTURE"]["SRC"];?>" style="background-image: url(<?=$arItem["PICTURE"]["SRC"];?>)">
							...
							<div class="loft-types__item" data-bg="<?=$arItem["PICTURE"]["SRC"];?>">
